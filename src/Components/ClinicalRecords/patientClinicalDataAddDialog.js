...
import '../ClinicalRecords/patientClinicalDataAddDialog.css';
...
function PatientClinicalDataAddDialog({ isOpen, onClose, onSubmit,patientId }) {
  ...
  const handleFormSubmit = async (e) => {
    ...
    if (validateForm()) {
      try {
        const response = await axios.post('https://group3-mapd713.onrender.com/api/clinical-tests/clinical-tests', {
          ...formData
        }, {
          headers: {
...
export default PatientClinicalDataAddDialog;
